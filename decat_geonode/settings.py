...
from decat_geonode import get_version
from decat_geonode.celeryapp import app  # flake8: noqa
...
SECRET_KEY = os.getenv('SECRET_KEY', "$fc8=8!z&*8(s+^2t+fxh##na^0*$sz65k=#07h16kb5a3)h%e")
...
ROOT_URLCONF = os.getenv('ROOT_URLCONF', 'decat_geonode.urls')
...
_DEFAULT_PYSCSW = {
    ...
    'CONFIGURATION': {
        ...
        #},
        'metadata:main': {
            'identification_title': 'decat_geonode Catalogue',
            ...
            'identification_keywords': 'sdi,catalogue,discovery,metadata,GeoNode, decat_geonode',
...
# It is used for relative settings elsewhere.
LOCAL_ROOT = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'static_root')

WSGI_APPLICATION = "decat_geonode.wsgi.application"
...
STATICFILES_DIRS.append(
    os.path.join(LOCAL_ROOT, "staticfiles"),
)

# Location of url mappings
ROOT_URLCONF = 'decat_geonode.urls'
