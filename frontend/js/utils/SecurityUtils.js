...
const rules = {
    ...
    edithazard: (user) => user && user.user && user.user.roles && user.user.roles.indexOf('impact-assessor') !== -1,
    showhazard: (user) => user && user.user && user.user.roles && user.user.roles.indexOf('emergency-manager') !== -1
};
